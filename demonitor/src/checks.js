...
{
	const r = [
		//{node: 'dev', interval: 0.1*60000, type: 'chat', target: 'localhost:88', timeout: 0.1*60000},
		...
		{node: 'azure', interval: 17*60000, type: 'chat', target: config.nodes.vmi1.url, timeout: 15*60000},
